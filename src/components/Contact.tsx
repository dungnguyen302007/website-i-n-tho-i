    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <section className="relative py-24 sm:py-32 bg-slate-900 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white space-y-6">
          ...
          >
            LIÊN HỆ <br/><span className="text-blue-600 not-italic">HỖ TRỢ</span>
          </motion.h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              <div className="bento-card p-10 bg-white space-y-10">
                <div>
                  <h3 className="text-xs font-black text-slate-900 mb-8 uppercase tracking-widest flex items-center">
                    <MessageSquare className="mr-3 text-blue-600" size={18} />
                    Thông tin
                  </h3>
                  <div className="space-y-8">
                    <div className="flex items-start space-x-5">
                      <div className="p-4 bg-slate-50 rounded-2xl text-blue-600 shrink-0 shadow-sm"><Phone size={22} /></div>
                      <div>
                    ...
                    <div className="flex items-start space-x-5">
                      <div className="p-4 bg-slate-50 rounded-2xl text-blue-600 shrink-0 shadow-sm"><Mail size={22} /></div>
                      <div>
                    ...
                    <div className="flex items-start space-x-5">
                      <div className="p-4 bg-slate-50 rounded-2xl text-blue-600 shrink-0 shadow-sm"><MapPin size={22} /></div>
                      <div>
                ...
                <div className="pt-10 border-t border-slate-100">
                   ...
                   <div className="flex flex-wrap gap-3">
                      {['FACEBOOK', 'INSTAGRAM', 'TIKTOK'].map(social => (
                        <div key={social} className="px-5 py-2.5 bg-slate-50 border border-slate-100 rounded-xl flex items-center justify-center font-black text-[10px] cursor-pointer hover:bg-blue-600 hover:text-white transition-all uppercase tracking-widest shadow-sm">
                          {social}
                        </div>
                      ))}
                   </div>
            ...
            <div className="lg:col-span-8">
              <div className="bento-card p-10 sm:p-16 bg-white shrink-0">
                <h3 className="text-3xl font-black text-slate-900 mb-10 tracking-tight italic uppercase">Gửi tin nhắn <span className="text-blue-600 not-italic">Trực tuyến</span></h3>
                  ...
                  <form className="space-y-8" onSubmit={handleSubmit}>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                      <div className="space-y-3">
                        ...
                        <input 
                          ...
                          className="w-full px-6 py-4 bg-slate-50 border-none rounded-2xl text-sm font-bold focus:ring-2 focus:ring-blue-600 transition-all outline-none"
                        />
                      </div>
                      <div className="space-y-3">
                    ...
                    <div className="space-y-3">
                      ...
                      <textarea 
                        ...
                        className="w-full px-6 py-4 bg-slate-50 border-none rounded-2xl text-sm font-bold focus:ring-2 focus:ring-blue-600 transition-all outline-none resize-none"
                      />
                    </div>
                    <button 
                      disabled={loading}
                      type="submit"
                      className="w-full py-5 bg-blue-600 text-white font-black uppercase tracking-widest text-xs rounded-2xl hover:bg-slate-900 transition-all flex items-center justify-center group shadow-2xl shadow-blue-200 disabled:opacity-50"
                    >
                      {loading ? (
      ...
      <section className="h-[500px] grayscale brightness-75 -mt-20 relative bg-slate-200 flex items-center justify-center border-t border-slate-300">
         <div className="bento-card-dark p-10 bg-slate-900 shadow-2xl">
            <p className="text-blue-400 font-black italic text-lg uppercase tracking-widest">Google Map Location</p>
         </div>
      </section>
    </div>
  );
